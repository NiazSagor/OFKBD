...
public class ResourceFragment extends Fragment {
     ...
     * @return A new instance of fragment ResourcekFragment.
     */
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_resourcek, container, false);
    }
    ...
    private void showAlertDialog(String command) {
        switch (command) {
            ...
            case "done":
                ...
                pDialog.setTitleText("রিসোর্স পাওয়া যায় নি")
                        .setConfirmText("OK")
